...
**Build 47 (9 September 2026, twelve items: the outstanding phone fixes, the widget, and notification delivery).** State first: the owner's phone had build 46 or earlier; the TEST server is still at 1230728 (none of the build 43–47 backend changes are deployed); nothing below is claimed as phone-verified.
