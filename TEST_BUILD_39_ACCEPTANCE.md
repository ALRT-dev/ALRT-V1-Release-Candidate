# TEST build 39 — install, acceptance and paywall guide

Version **1.0.5 (39)**, commit **c10b892**, branch `test`, dev flavour
...
production "ALRT" app, not over it, and they replace TEST builds 36 to 38.
...
example:
    ...
    ALRT 1.0.5 (39) · TEST build · c10b892 · RevenueCat Test Store
